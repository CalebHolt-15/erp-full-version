...
const Register = () => {
  ...
  const [email, setEmail] = useState("mnmn@gmail.com")
  ...
  const onSubmit = async (values) => {
    ...
    try {
      ...
      console.log("singed(response)up:", data1)
      // toggleLoading()
      // enqueueSnackbar("Welcome")
      // dispatch(handleLogin(data1))
      history.push("/")
    } catch (e) {
      console.error(e)
      // if (e.response.status === 400) {
      //   enqueueSnackbar("User with provided phone-number already exists")
        ...
        >
          <Col className="px-xl-2 mx-auto" sm="8" md="6" lg="12">
            ...
            >
              ...
              <FormGroup>
                <Label className="form-label" for="ability.action">
                  ability.action
                </Label>
                <Input
                  autoFocus
                  ...
                  name="ability.action"
                  className="input-group-merge"
                  // onChange={(e) => setAbiliti(e.target.value)}
                  className={classnames({
                    "is-invalid": errors["ability.action"]
                  })}
                  innerRef={register({
                    required: true,
                    validate: (value) => value !== ""
              ...
              <FormGroup>
                <Label className="form-label" for="ability.subject">
                  abiliti.subject
                </Label>
                <Input
                  autoFocus
                  ...
                  // onChange={(e) => setPassword(e.target.value)}
                  className={classnames({
                    "is-invalid": errors["ability.subject"]
                  })}
                  innerRef={register({
                    required: true,
                    validate: (value) => value !== ""
